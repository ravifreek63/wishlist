...
public class LoginActivity extends Activity {
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			LoginPost post = new LoginPost(mEmail, mPassword);
			mAuthTask.execute(post);
		}
	}
	...
	private class LoginPost extends HttpPost.SendableObject {
	 ...
	 * the user.
	 */
	public class LoginTask extends AsyncTask<LoginPost, Void, String> {
		@Override
		protected String doInBackground(LoginPost... posts) {
			ConnectivityManager cm = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
			// Attempt to log in.
			LoginPost post = posts[0];

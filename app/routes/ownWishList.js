...
var connection = require('../data/dataConnection.js');
var methods = require('../helperMethods/headersConstructors.js');
...
exports.editItems = function (req, res){
    ...
    var query = "UPDATE ItemDetails SET (brand = '" + itemObj.brand +"',price = '" + itemObj.price + "') 
...
var runQuery = function runQuery (resMsg, resMsgErr, query, res){
    var resCb = function (error, resOb){
        if (error) {
